<%-- 
    Document   : index
    Created on : Apr 1, 2023, 9:30:07 PM
    Author     : Dell
--%>
    ...
    <body>
        <div class="mainbody">
                ...
                <div class="icon-groups">
                    <div class="list">
                        <ul>
                            ...
                            <li> <a id="login-profile" style="cursor:pointer;"><i class='bx bx-user-circle bx-sm'></i></a></li>
            ...
            <div class="container1">
                <img src="${pageContext.request.contextPath}/img/store.png" style=" height: 675px; width:100%">
                <div class="inner">
                    <!-- <h1>
                       The BEST of <br>
                    Stationery Products
            ...
            <div class="container3">
                <div class="box1">
                    <img src="${pageContext.request.contextPath}/img/planner.png" style=" height: 400px; width:100%" class="center">
                </div>
                <div class="box2">
                    <h2> Stationery Archieve Sale</h2>
                    <p> Looking for stationery on discount? Shop all of our stationery sale items below. <br>
                        Please note our stores have many more archive options. If you can't find what you're looking for,
                        visit us in person for a juicy collection of store sale exclusives.</p>
                </div>
            </div>
    ...
    <script>
        ...
        login_profile.addEventListener("click", () => {
            checkLoginStatus().then((isLoggedIn) => {
                ...
                if (isLoggedIn) {
                    window.location.href = "http://localhost:8181/CRAFTYS/UserServlet?page=profile";
                } else {
                     window.location.href = "http://localhost:8181/CRAFTYS/UserServlet?page=login";
                }
            });
        });
