  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
     ...
     <!-- End Tables Nav -->
      ...
      <li class="nav-item">
        <a class="nav-link " href="AdminController?page=user_profile">
          <i class="bi bi-person"></i>
          <span>Profile</span>
        </a>
        ...
        <div class="col-xl-4">
          ...
          <div class="card">
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
              ...
              <!-- <img src="CraftysAdmin/assets/img/profile-img.jpg" alt="Profile" class="rounded-circle"> -->
              <h2><c:out value="${username}"/></h2><br>
           
              <div class="social-links mt-2">
                <a href="UserServlet?page=twitter" class="twitter"><i class="bi bi-twitter"></i></a>
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><c:out value="${username}"/></div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><c:out value="${email}"/></div>
                  </div>
