<%-- 
    Document   : art_category
    Created on : Apr 2, 2023, 3:26:23 PM
    Author     : Dell
--%>
...
<html>
    ...
    <body>
        ...
        <section>
            <div class="row">
                <div class="row1">
                    <img src="artr.jpg" height="230px" width="100%">
                </div>
                <div class="row2">
                ...
                <div class="category-list1">
                   <h2>Products</h2>
                    ...
                    <div class="bigbox">
                        <div class="box">
                            <div class="imgbox">
                                <img src="planner.jpg" height="230px" width="100%">
                            </div>
                            <div class="textbox">
                                <h3>Planner ysfxyd</h3>
                                <p>Rs. 600</p>
