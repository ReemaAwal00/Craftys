<%-- 
    Document   : reset
    Created on : Apr 13, 2023, 5:40:04 PM
    Author     : Dell
--%>
...
<body>
    <div class="mainbody">
        ...
        <div class="loginbox">
            <form class="first" action="UserServlet?page=resetPassword&email=${email}" method="post">
                <h1>Reset your password</h1>
             

                <input type="password" name="password" id="username" placeholder="New Password" required>
