            ...
            <ul class="d-flex align-items-center">
                ...
                <li class="nav-item dropdown pe-3">
                    ...
                    <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
                        ...
                        <span class="d-none d-md-block dropdown-toggle ps-2">Reema Awal</span>
        ...
        <section class="section">
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="accordion" id="accordionExample">
                                ...
                                <form action="UserServlet?page=addproduct" method="post">
                        ...
                        <div class="card-body">
                            <div class="catelog">
                                <h5 class="card-title">Select the category</h5>
                                    ...
                                    <p>Please select your product category:</p>
                                      <input type="radio" id="arrival" name="arrival" value="arrival">
                                      <label for="html">New Arrival</label><br>

                                      <input type="radio" id="home" name="home" value="home">
                                      <label for="home">Featured product</label><br>

                                      <input type="radio" id="Office" name="office" value="office">
                                      <label for="Office">Office Stationery</label><br>

                                      <input type="radio" id="javascript" name="fav_language" value="JavaScript">
                                      <label for="javascript">Student stationery</label><br>

                                      <input type="radio" id="javascript" name="fav_language" value="JavaScript">
                                      <label for="javascript">Arts supplies</label><br>

                                      <input type="radio" id="javascript" name="fav_language" value="JavaScript">
                                      <label for="javascript">Notebooks</label><br>

                                      <input type="radio" id="javascript" name="fav_language" value="JavaScript">
                                      <label for="javascript">Desk accessories</label><br>

                                      <input type="radio" id="javascript" name="fav_language" value="JavaScript">
                                      <label for="javascript">Writing Instruments</label><br>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Insert image file</h5>
                ...
                <div class="done">
                    <button type="submit"><a href="viewproduct.html">Done</a></button>
                    <button type="submit"><a href="addproduct.html">Cancel</a></button>
                </div>
