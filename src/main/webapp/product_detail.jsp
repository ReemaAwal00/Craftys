...
<html>
    ...
    <!-- Cart container End -->
        ...
        <div class="loginbox">
            ...
            <div class="box2">
                ...
                <div class="box-2-submit">
                    ...
                    <button class="buy">
                        <a href="checkout.html">Buy Now </a></button>
                </div>
                <hr>
                <div class="description">
                    <p>${product.product_Describe}<br>usvcyuayvjavcsycvsvac
                     </p><br>
                     
                    <span>Designed and made in China</span>
                </div>
            </div>
        ...
        <div class="shop">
            ...
            <a href="category.html">Continue shopping</a></button>
        </div>
        <div class="footer">
            <div class="footerbox">
                <div class="title">
