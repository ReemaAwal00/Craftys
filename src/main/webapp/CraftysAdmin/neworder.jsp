            ...
            <ul class="sidebar-nav" id="sidebar-nav">
                ...
                <li class="nav-item">
                    ...
                    <ul id="forms-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                        <li>
                            <a href="AdminController?page=neworder" class="active">
                                ...
                                <table class="table datatable">
                                    ...
                                    <tbody> 
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="${pageContext.request.contextPath}/img/${order.product_img}" alt="sd" style="width: 150px; height: 100px;"></td>
