    ...
    <body>
        ...
        <aside id="sidebar" class="sidebar">
            ...
            <ul class="sidebar-nav" id="sidebar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link " href="AdminController?page=customer">
...
<!--                                                <td><a href="AdminController?page=DeletedProduct&productId=${product.product_id}"><span class="badge bg-danger"><i class="bi bi-exclamation-octagon me-1"></i> Remove</span></a></td>-->
                                            </tr>
                                        </c:forEach>
<!--                                        <tr>
                                            <th scope="row">2</th>
        ...
        <script src="https://cdnjs.cloudflare.com/ajax/libs/tinymce/6.4.1/tinymce.min.js" integrity="sha512-in/06qQzsmVw+4UashY2Ta0TE3diKAm8D4aquSWAwVwsmm1wLJZnDRiM6e2lWhX+cSqJXWuodoqUq91LlTo1EA==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>  <script src="CraftysAdmin/assets/vendor/php-email-form/validate.js"></script>
